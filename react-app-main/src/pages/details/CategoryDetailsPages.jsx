...
export const CategoryDetailsPages = () => {
    ...
    useEffect(() => {
        const fetchBlog = async () => {
            try {
                const response = await axios.get(`http://localhost:5000/users/category/${id}`);
    ...
    const handleDelete = async () => {
        ...
        if (confirmDelete) {
            try {
                await axios.delete(`http://localhost:5000/users/category/${id}`);
                history.push("/");
            } catch (error) {
    ...
    const editCategory = async () => {
        try {
          ...
          const response = await axios.put(`http://localhost:5000/users/category/${id}`, formData, {
            headers: {
            ...
            {loading ? (
                ...
                <section className='singlePage'>
                    <div className='container'>
                        <div className='left'>
                            <img src={`http://localhost:5000/${category.cover}`} alt='' />
                        </div>
                        <div className='right'>
